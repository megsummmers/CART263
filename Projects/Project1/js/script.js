...
function preload(){
  ...
  img1Base = loadImage('assets/images/01-base.png');
  img1ChestP = loadImage('assets/images/01-chest.png');
  img1ChestB = loadImage('assets/images/01-chest2.png');
  img1ChestR = loadImage('assets/images/01-chest3.png');
  img1EyesP = loadImage('assets/images/01-eyes.png');
  img1EyesB = loadImage('assets/images/01-eyes2.png');
  img1EyesR = loadImage('assets/images/01-eyes3.png');
